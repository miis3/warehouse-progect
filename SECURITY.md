...
- إنشاء حسابات الموظفين وتغيير كلمات المرور في Preview يستخدمان مخزن هوية داخل ذاكرة العملية بدل Supabase Auth؛ فرض الدور والملكية يبقى عبر RPC وقاعدة PGlite. كلمات مرور الاختبار لا تُكتب إلى الملفات أو السجلات، وتُمحى بانتهاء العملية. هذا المحاكي لا يدخل صورة الإنتاج.
